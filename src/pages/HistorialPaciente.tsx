      ...
      <div className="card-academic">
        <header className="banner-header">
          ...
          <p>
            ...
            {paciente.paciente?.person?.apellidoPaterno} - Semestre{" "}
            {paciente.semestre}
          </p>
        </header>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p style={{ margin: "4px 0 0 0", fontSize: "16px" }}>
                {paciente.paciente?.person?.celular}
              </p>
            </div>
            <div>
              <span
            ...
            <div>
              ...
              <p style={{ margin: "4px 0 0 0", fontSize: "16px" }}>
                {paciente.psicologo?.person?.primerNombre}{" "}
                {paciente.psicologo?.person?.apellidoPaterno}
              </p>
            </div>
            <div>
              <span
          ...
          {sesiones.length === 0 ? (
            ...
            >
              ...
              <p style={{ fontSize: "14px", marginTop: "8px" }}>
                Haga clic en "Nueva Sesión" para comenzar.
              </p>
            </div>
          ) : (
            <div
                      ...
                      >
                        ...
                        <button
                          ...
                          style={{
                            minWidth: "100px",
                            height: "36px",
                            // Agrega estas líneas para centrar:
                            display: "flex",
